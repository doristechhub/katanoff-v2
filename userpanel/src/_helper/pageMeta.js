...
export const PAGE_META = {
  ...
  [META_CONSTANTS.CONTACT_US]: {
    ...
    keywords: "contact Katanoff, jewelry support, jewelry help",
  ...
  [META_CONSTANTS.CUSTOM_JEWELRY]: {
    ...
    keywords: "custom jewelry, jewelry design, personalized jewelry",
  ...
  [META_CONSTANTS.PAYMENT_FINANCING]: {
    ...
    keywords: "jewelry financing, payment plans, Katanoff payment",
  ...
  [META_CONSTANTS.BOOK_APPOINTMENT]: {
    ...
    keywords: "book appointment, jewelry appointment, Katanoff visit",
    url: `${WebsiteUrl}/book-appointment`,
  },

  [META_CONSTANTS.PRIVACY_POLICY]: {
    title: "Privacy Policy – Katanoff",
    description: "Learn how Katanoff protects your privacy and personal data.",
    keywords: "privacy policy, Katanoff privacy, jewelry data",
  ...
  [META_CONSTANTS.RETURN_POLICY]: {
    ...
    keywords: "return policy, jewelry returns, Katanoff refund",
  ...
  [META_CONSTANTS.SHIPPING_POLICY]: {
    ...
    keywords: "shipping policy, jewelry shipping, Katanoff delivery",
  ...
  [META_CONSTANTS.TERMS_AND_CONDITIONS]: {
    ...
    keywords: "terms and conditions, jewelry terms, Katanoff terms",
  ...
  [META_CONSTANTS.TRACK_YOUR_RETURN]: {
    ...
    keywords: "track return, jewelry return, refund status",
  ...
  [META_CONSTANTS.TRACK_YOUR_ORDER]: {
    ...
    keywords: "track order, jewelry tracking, Katanoff order",
  ...
  [META_CONSTANTS.WARRANTY]: {
    ...
    keywords: "jewelry warranty, diamond warranty, Katanoff guarantee",
  ...
  [META_CONSTANTS.SELECT_DIAMOND]: {
    ...
    keywords: "select diamond, buy diamond, engagement diamond",
  ...
  [META_CONSTANTS.ABOUT_US]: {
    ...
    keywords: "about Katanoff, jewelry brand, fine jewelry story",
  ...
  [META_CONSTANTS.EDUCATION]: {
    ...
    keywords: "jewelry education, diamond guide, jewelry learning",
